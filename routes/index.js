...
res.render('index', { title: 'Errings App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'animals App Registration'});
});
...
router.get('/Login', function(req, res) {
  res.render('Login', { title: 'animals App Login', user : req.user });
  });
